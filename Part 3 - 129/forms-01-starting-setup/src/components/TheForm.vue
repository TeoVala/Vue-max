<template>
  <form @submit.prevent='submitForm'>
    <div class='form-control' :class='{invalid: userNameValidity === "invalid"}'>
      ...
      <p v-if='userNameValidity === "invalid"'> Please enter a valid class </p>
    </div>
    ...
    <div class='form-control'>
      ...
      <div>
        <input id='how-video' name='how' type='radio' value='vide' v-model='how' />
...
export default {
  ...
  methods: {
    submitForm() {
      ...
      console.log(this.confirm); // this is true false the other is aray
